            ...
            builder: (context, snap) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // ✅ theoryText: من الداتابيس لو موجود، وإلا fallback
                    final theoryText =
                    (data['theoryText'] ?? "Theory content for $title") as String;
                    ...
                    // ✅ modelSrc: ياخذ رابط Supabase لو موجود، وإلا fallback من assets
                    final modelUrl = (data['modelUrl'] ?? data['modelSrc'] ?? '') as String;
                    const modelFallbackAsset = 'assets/models/newtons_cradle.glb';
                    final modelSrc = modelUrl.isNotEmpty ? modelUrl : modelFallbackAsset;
